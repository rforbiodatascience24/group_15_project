...
saveRDS(count_data_clean, 
        file = here("presentation_data/02_count_data.rds"))
```

```{r}

saveRDS(clinical_data_clean, 
        file = here("presentation_data/02_clinical_data.rds"))
```

```{r}

saveRDS(count_data_DESeq_clean, 
          here("presentation_data/02_count_data_clean_DESeq.rds"))
```
