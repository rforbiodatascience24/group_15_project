...
Drop irrelevant columns in the mapping of ensemble id to gene symbol.
...
Join the count_data and ensemble_to_gene_symbol tables on the "Ensembl_ID" column.

```{r}
count_data <- count_data |>
  inner_join(
    ensemble_to_gene_symbol, 
    by = "Ensembl_ID"
    ) |>
  select(-Ensembl_ID) |>
  relocate(gene)
