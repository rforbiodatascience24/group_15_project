...
Differential gene expression analysis will be conducted using the R package "DESeq2". The objective is to identify genes that are significantly differently expressed among patients with lung adenocarcinoma across three distinct groups: light, medium and heavy smokers.
...
1.  Extract significant differently express genes: Genes with values of log2FoldChange greater than 2 and p-value below 0.05 are extracted and tidied into a data frame
...
3.  Transform data frame to the tidy format
