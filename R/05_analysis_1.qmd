...
Results derived from DESeq analysis are extracted specifying the groups to be compared and the level of significance.
...
2. Extracting normalized counts: normalization accounts for sequencing depth, library size
